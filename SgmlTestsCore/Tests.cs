...
namespace SGMLTestsCore {
    ...
    public partial class Tests {
        ...
        [Xunit.Fact(Skip="marked as ignore, because it conflicts with another behavior of never pushing elements from the body tag")]
        ...
        public void Test_for_illegal_char_value() 
        {
            ...
            Assert.False(string.IsNullOrEmpty(value), "element has no value");
            Assert.NotEqual<char>((char)65535, value[value.Length - 1]);
        }
    }
}